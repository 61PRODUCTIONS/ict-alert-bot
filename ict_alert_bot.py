...
def send_trade_alert(setup: TradeSetup):
    ...
    message = f"""
{dir_emoji} *ICT B-SETUP ALERT v4.0* {dir_emoji}
...
📈 *SCHRITT 1 - H4 BIAS:*
   {setup.bias.value}
   _{setup.bias_reason}_

🕐 *Kill Zone:* {kz_names.get(setup.kill_zone, setup.kill_zone)}
📍 *Session:* {setup.session_alignment}

━━━━━━━━━━━━━━━━━━━━
{poi_emoji.get(setup.point_of_interest.poi_type.value, '📍')} *SCHRITT 2 - H1 POI:*
   {setup.point_of_interest.poi_type.value}
   Zone: {setup.point_of_interest.zone_bottom} - {setup.point_of_interest.zone_top}
   {zone_emoji.get(setup.point_of_interest.price_zone.value, '')} *{setup.point_of_interest.price_zone.value}* Zone
   {"✅ Unmitigated" if setup.point_of_interest.is_unmitigated else "⚠️ Mitigated"}

━━━━━━━━━━━━━━━━━━━━
↘️ *SCHRITT 3 - M15 ZONE ENTRY:*
   Preis in Zone bei: {setup.zone_entry.entry_price}

━━━━━━━━━━━━━━━━━━━━
{trigger_emoji.get(setup.entry_trigger.trigger_type.value, '✅')} *SCHRITT 4 - M5 TRIGGER:*
