...
Ein automatisierter Forex-Alert-Bot, der auf **ICT (Inner Circle Trader) Konzepten** basiert.

## NEU in v8.7: Smart Alignment

Die neue intelligente Alignment-Prüfung basiert auf dem Daily-Trend als übergeordnetem Filter:

1. **Daily muss klar sein** (BULLISH oder BEARISH, nicht NEUTRAL)
2. **H1 muss = Daily sein** (gleiche Richtung)
3. **H4 darf NEUTRAL sein** (Pullback/Konsolidierung erlaubt)

### Alignment-Beispiele:
| Daily | H4 | H1 | Ergebnis |
|-------|----|----|----------|
| BULLISH | BULLISH | BULLISH | ✅ PERFEKT |
| BULLISH | NEUTRAL | BULLISH | ✅ mit Warnung |
| BULLISH | BEARISH | BULLISH | ❌ Konflikt |
| NEUTRAL | BULLISH | BULLISH | ❌ Daily unklar |
| BULLISH | BULLISH | BEARISH | ❌ H1 Konflikt |
